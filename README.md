# Project 2 - *Twitter Emulator* - PART 2

**Twitter Emulator** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
In general, this was simple to implement. Using the CodePath libraries for the OAuth and HTTP client greatly helped me get moving on the functionality.
